...
test('Manage Zs lookup and history reject anonymous access',async()=>{for(const manage of ['users','history']){const r=response();await api({method:'GET',query:{manage,q:'Zeek'},headers:{}},r);assert.equal(r.statusCode,401);}});
