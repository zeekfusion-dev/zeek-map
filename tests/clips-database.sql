do $$declare s jsonb;l uuid:='80000000-0000-4000-8000-000000000001';begin
 ...
 if not z_finish_social('instagram',l,'[{"id":"one","title":"First","url":"https://www.instagram.com/reel/one/","views":2000},{"id":"two","title":"Second","url":"https://www.instagram.com/reel/two/","views":2001}]','{"after":"second-page"}','fixture') then raise exception 'Page save failed';end if;
 if (select count(*) from z_clips where views>2000)<>1 then raise exception 'Popular boundary';end if;
